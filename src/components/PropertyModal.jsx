...
import { FaChevronLeft, FaChevronRight, FaHeart, FaBed, FaBath, FaRuler } from "react-icons/fa";
    ...
    >
      ...
      >
        <div className="relative h-[300px] md:h-[400px]">
          ...
          <button
            onClick={prevImage}
            className="absolute top-1/2 left-4 -translate-y-1/2 bg-white/80 p-2 rounded-full hover:bg-white"
          >
            <FaChevronLeft size={20} />
          </button>
          <button
            onClick={nextImage}
            className="absolute top-1/2 right-4 -translate-y-1/2 bg-white/80 p-2 rounded-full hover:bg-white"
          >
